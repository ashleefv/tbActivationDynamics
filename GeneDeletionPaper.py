...
model3.dT_8dt = types.MethodType(DeleteGene, model)
...
model4.dI_ydt = types.MethodType(DeleteGene, model)
...
plt.legend(loc=int(4), fontsize = fontSize - 3)
plt.xlabel('Time (Days)', fontsize = fontSize)
...
plt.legend(loc=(0.6, 0.4), fontsize = fontSize)
plt.xlabel('Time (Days)', fontsize = fontSize)
...
plt.legend(loc=int(5), fontsize = fontSize)
plt.xlabel('Time (Days)', fontsize = fontSize)
