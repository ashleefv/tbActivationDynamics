...
def WSDetModel(y,t,p):
    ...
    dM_Idt = (p['k_2']*M_R * (B_E / (B_E + p['c_9']))
            -p['k_17']*M_I * (B_I**2 / (B_I**2 + (p['N']*M_I)**2)) + 
    ...
    dI_ydt = (p['s_g'] * B_T/(B_T + p['c_10']) * I_12/(I_12 + p['s_7']) +
            p['a_5a']*T_1 * M_A/(M_A + p['c_5b']) +
            p['a_5b']*T_8 * M_A/(M_A + p['c_5a']) +
            p['a_5c']*M_I +
            p['a_7']*T_0 * I_12/(I_12 + p['f_4']*I_10 + p['s_4']) +
            p['a_7']*T_80 * I_12/(I_12 + p['f_4']*I_10 + p['s_4']) +
            -p['u_iy']*I_y)
    ...
    dB_Idt = (p['a_19']*B_I * (1 - B_I**2/(B_I**2 + (p['N']*M_I)**2)) +
            p['k_2'] * p['N']/2 * M_R * B_E/(B_E + p['c_9']) +
            -p['k_17']*p['N']*M_I * B_I**2/(B_I**2 + (p['N']*M_I)**2) +
